Public Class frmDivision
    Private Sub frmMenu_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtWelcome.Text = "Hello " + General.Name + " please answer the division questions"
        If Type = 1 Then
            General.Answer = Format(Convert.ToInt32(General.Number1) / Convert.ToInt32(General.Number2), "0.##")
    ...
    Private Sub CheckAns()
        If (IsEmptyNullOrWhitespaceOnly(txtNum1.Text) Or IsEmptyNullOrWhitespaceOnly(txtNum2.Text) Or IsEmptyNullOrWhitespaceOnly(txtNum3.Text)) = False Then
            Try
                If Type = 1 Then
                    If Convert.ToDecimal(txtNum3.Text) = General.Answer Then
                    ...
                    End If
                ElseIf Type = 2 Then
                    If Convert.ToDecimal(txtNum2.Text) = General.Number1 / General.Answer Then
                        imgDetails.Visible = True
                        txtDetails.Visible = True
                        txtDetails.Text = "Well Done"
                        imgDetails.Image = My.Resources.accept
                    ...
                    End If
                ElseIf Type = 3 Then
                    If Convert.ToDecimal(txtNum1.Text) = General.Answer * General.Number2 Then
                        imgDetails.Visible = True
                        txtDetails.Visible = True
                        txtDetails.Text = "Well Done"
                        imgDetails.Image = My.Resources.accept
